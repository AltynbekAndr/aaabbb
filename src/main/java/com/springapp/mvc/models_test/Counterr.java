package com.springapp.mvc.models_test;
...
public class Counterr {
    ...
    private String podkl;
    private String data_podkl;
    private String fio_podkl;
    private String note;
    private String kod_prich;
    private String note2;
    private String kto;
    private String filename;
    private String xmldoc;
    private String type_meter;
    private String type_mvalue;
    ...
    public String getPodkl() {
        return podkl;
    }

    public void setPodkl(String podkl) {
        this.podkl = podkl;
    }

    public String getData_podkl() {
        return data_podkl;
    }

    public void setData_podkl(String data_podkl) {
        this.data_podkl = data_podkl;
    }
    ...
    public String getKod_prich() {
        return kod_prich;
    }

    public void setKod_prich(String kod_prich) {
    ...
    public String getType_mvalue() {
        return type_mvalue;
    }

    public void setType_mvalue(String type_mvalue) {
